      ...
      <aside className='testimonial'>
        <Link href='/'>
          ...
          <div className='description'>
              <section>
                  ...
                  <p> SnapCast makes screen recording easy. From quick walkthroughs to full presentations,
                      it's fast, smooth, and shareable in seconds</p>
                  <article>
        ...
        <aside className="google-sign-in">
            <section>
                ...
                <p>Start Your First <span> SnapCast</span> in Seconds!</p>
            <button>
